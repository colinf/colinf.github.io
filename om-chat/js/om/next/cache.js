...
var id_SINGLEQUOTE__21281 = self__.arr.shift();
cljs.core.swap_BANG_.call(null,self__.index,((function (id_SINGLEQUOTE__21281,this$){
return (function (p1__21280_SHARP_){
return cljs.core.assoc.call(null,cljs.core.dissoc.call(null,p1__21280_SHARP_,id_SINGLEQUOTE__21281),id,x);
});})(id_SINGLEQUOTE__21281,this$))
);
} else {
